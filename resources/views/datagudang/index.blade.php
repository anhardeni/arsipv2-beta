        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="basic-form">
                    <form action="{{ route('datagudang.create')}}" method="POST">
                        @csrf
                        <div class="form-group row">
                            <label for="nama_gudang" class="col-sm-3 col-form-label">Nama Gudang</label>
                            <div class="col-sm-9">
                                <input type="text" value="{{ old('nama_gudang') }}" name="nama_gudang" id="nama_gudang" class="form-control border border-light @error('nama_gudang') is-invalid @enderror" placeholder="Nama Gudang" required>
                                @error('nama_gudang')
