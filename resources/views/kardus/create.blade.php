...
@section("title") Save No Kardus @endsection
                ...
                <div class="basic-form">
                    <form action="{{route('kardus.store')}}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="no_kardus" id="no_kardus" class="form-control border border-light bg-light" value="{{ $no_kardus }}" readonly required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="date" name="tanggal_kardus" id="tanggal_kardus" class="form-control border border-light" required>
                            </div>
                        </div>
