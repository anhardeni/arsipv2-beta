...
@section("title") Peminjaman Edit @endsection
...
<div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{route('peminjaman.index')}}">Index</a></li>
                ...
                <div class="basic-form">
                    <form>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control border border-light bg-light" value="{{ $peminjaman->nd_masuk}}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control border border-light bg-light" value="{{ $peminjaman->tgl_nd_masuk}}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control border border-light bg-light" value="{{ $peminjaman->asal_nd }}" readonly>
                            </div>
                        </div>
        ...
        <div class="card">
            ...
            <div class="card-body" style="margin-top: -25px">
                <div class="basic-form">
                    ...
                    <form action="{{ route('peminjaman.pinjam', ['id'=>$peminjaman->id]) }}" method="POST">
                        @csrf
                        <div class="form-group row">
...
<script>
    var table = $('#peminjamanDetail-table').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "{{ route('peminjaman.detail', ['id'=>$peminjaman->id]) }}",
        columns: [{
                data: 'DT_RowIndex',
                name: 'DT_RowIndex'
            },
