            ...
            <div class="card-body">
                ...
                <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <form method="post" action="{{ route('pendok.import') }}" enctype="multipart/form-data">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="basic-form">
                                    ...
                                    <form action="{{route('pendok.store')}}" method="POST">
                                        @csrf
                                        ...
                                        <div class="form-group row" style="margin-top: -10px">
                                            ...
                                            <div class="col-sm-8">
                                                <select id="pfpd" name="pfpd" class="form-control">
                                                    @foreach($pfpd as $pfp)
                                                    <option value="{{$pfp->pfpd}}">{{$pfp->pfpd}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>

                                        <input type="text" name="nip_pfpd" id="nip_pfpd" value="{{$pfp->nip_pfpd}}" hidden>
                                        ...
                                        <input class="form-control" id="tgl_tt" name="tgl_tt" value="{{\Carbon\Carbon::now()->format('d-m-Y H:i:s')}}" hidden>
