...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form onsubmit="return confirm('Are you sure move all data ?')" class="d-inline" action="{{ route('imporpib.move_bc25') }}" method="POST">
                @csrf
            ...
            <form onsubmit="return confirm('Are you sure delete all data ?')" class="d-inline" action="{{ route('imporpib.hapus') }}" method="POST">
                @csrf
            ...
            <div class="modal fade" id="imporpib" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <form method="post" action="{{ route("imporpib.impor_excel_bc25") }}" enctype="multipart/form-data">
