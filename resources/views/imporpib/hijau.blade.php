...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form onsubmit="return confirm('Are you sure move all data ?')" class="d-inline" action="{{ route('imporpib.move') }}" method="POST">
                @csrf
            ...
            <div class="modal fade" id="imporpib" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <form method="post" action="{{ route("imporpib.impor_excel_hijau") }}" enctype="multipart/form-data">
