<?php $__env->startSection("title"); ?> Import Data <?php $__env->stopSection(); ?>
...
<div class="col-lg-12">
    <div class="card">
        <div class="card-header" style="margin-bottom: -30px">
            <h4 class="card-title">Impor Data BC 2.5</h4>
        </div>
        <div class="card-body">
            ...
            <form onsubmit="return confirm('Are you sure move all data ?')" class="d-inline" action="<?php echo e(route('imporpib.move_bc25')); ?>" method="POST">
                <?php echo csrf_field(); ?>
            ...
            <form onsubmit="return confirm('Are you sure delete all data ?')" class="d-inline" action="<?php echo e(route('imporpib.hapus')); ?>" method="POST">
                <?php echo csrf_field(); ?>
            ...
            <div class="modal fade" id="imporpib" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <form method="post" action="<?php echo e(route("imporpib.impor_excel_bc25")); ?>" enctype="multipart/form-data">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Import Excel BC 2.5</h5>
                            </div>
...
<script>
    ...
    var table = $('#imporpib-table').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('imporpib.list')); ?>",
        columns: [{
                data: 'DT_RowIndex',
                name: 'DT_RowIndex',
                searchable: false,
...
<?php echo $__env->make("layouts.global", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\arsipv2-beta\resources\views/imporpib/bc25.blade.php ENDPATH**/ ?>