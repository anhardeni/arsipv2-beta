<?php $__env->startSection("title"); ?> Nama Jabatan <?php $__env->stopSection(); ?>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Data Nama jabatan</h4>
            </div>
            <div class="card-body">
                <div class="d-flex justify-content-between" style="margin-top: -30px">
                    <button type="button" class="btn btn-rounded btn-primary mb-2" data-toggle="modal" data-target="#add_jabatan"><i class="fa fa-plus"> Add Nama jabatan</i></button>
                </div>
                ...
                <div class="table-responsive">
                    <table class="display" id="jabatan-table" style="min-width: 845px">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama jabatan</th>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Nama jabatan</h5>
                ...
                <div class="basic-form">
                    <form action="<?php echo e(route("jabatan.store")); ?>" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="nama_jabatan" id="nama_jabatan" class="form-control border border-light" placeholder="Nama jabatan" required>
                            </div>
                        </div>
...
<script>
    var table = $('#jabatan-table').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('jabatan.list')); ?>",
        columns: [{
                data: 'DT_RowIndex',
                name: 'DT_RowIndex'
            },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.global", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\arsipv2-beta\resources\views/jabatan/index.blade.php ENDPATH**/ ?>