...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form onsubmit="return confirm('Are you sure move all data ?')" class="d-inline" action="<?php echo e(route('imporpib.move_merah')); ?>" method="POST">
                <?php echo csrf_field(); ?>
            ...
            <form onsubmit="return confirm('Are you sure delete all data ?')" class="d-inline" action="<?php echo e(route('imporpib.delete')); ?>" method="POST">
                <?php echo csrf_field(); ?>
            ...
            <div class="modal fade" id="imporpib" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <form method="post" action="<?php echo e(route("imporpib.impor_excel_merah")); ?>" enctype="multipart/form-data">
...
<?php echo $__env->make("layouts.global", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\arsipv2-beta\resources\views/imporpib/merah.blade.php ENDPATH**/ ?>