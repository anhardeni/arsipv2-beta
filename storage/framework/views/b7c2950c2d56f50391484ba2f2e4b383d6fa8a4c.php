<?php $__env->startSection("title"); ?> Data Jenis Dokumen <?php $__env->stopSection(); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="basic-form">
                    <form action="<?php echo e(route('jenisdok.create')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="form-group row">
                            <label for="nama_dokumen" class="col-sm-3 col-form-label">Nama dokumen</label>
                            <div class="col-sm-9">
                                <input type="text" value="<?php echo e(old('nama_dokumen')); ?>" name="nama_dokumen" id="nama_dokumen" class="form-control border border-light <?php $__errorArgs = ['nama_dokumen'];
...
unset($__errorArgs, $__bag); ?>" placeholder="Nama Dokumen" required>
...
<script>
    ...
    var table = $('#jenisdok-table').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('jenisdok.list')); ?>",
        columns: [{
                data: 'DT_RowIndex',
                name: 'DT_RowIndex'
            },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.global", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\arsipv2-beta\resources\views/jenisdok/index.blade.php ENDPATH**/ ?>