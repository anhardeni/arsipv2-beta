<?php $__env->startSection("title"); ?> Jenisdok <?php $__env->stopSection(); ?>
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="d-flex justify-content-between">
                <a href="<?php echo e(route('jenisdok.create')); ?>" class="btn btn-rounded btn-primary btn-sm mb-3"> <i class="fa fa-plus"> tambah 
                Jenis Dok</i></a>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.global", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\arsip-bete\resources\views/jenisdok/index.blade.php ENDPATH**/ ?>