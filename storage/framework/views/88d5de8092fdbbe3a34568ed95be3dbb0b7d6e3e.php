<?php $__env->startSection("title"); ?> Data Gudang <?php $__env->stopSection(); ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between" style="margin-top: -30px; margin-bottom: 10px;">
                    <button type="button" class="btn btn-rounded btn-primary mb-2" data-toggle="modal" data-target="#add_gudang"><i class="fa fa-plus"> Add GUDANG</i></button>
                </div>
                ...
                <div class="table-responsive">
                    <table class="display" id="datagudang-table" style="min-width: 845px">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama Gudang</th>
...
<div class="modal fade" id="add_gudang">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Gudang</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="basic-form">
                    <form action="<?php echo e(route('datagudang.create')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="form-group row">
                            <label for="nama_gudang" class="col-sm-3 col-form-label">Nama Gudang</label>
                            <div class="col-sm-9">
                                <input type="text" value="<?php echo e(old('nama_gudang')); ?>" name="nama_gudang" id="nama_gudang" class="form-control border border-light <?php $__errorArgs = ['nama_gudang'];
...
unset($__errorArgs, $__bag); ?>" placeholder="Nama Gudang" required>
...
<script>
    ...
    var table = $('#datagudang-table').DataTable({
        pageLength: 10,
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('datagudang.list')); ?>",
        columns: [{
                data: 'DT_RowIndex',
                name: 'DT_RowIndex'
            },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.global", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\arsipv2-beta\resources\views/datagudang/index.blade.php ENDPATH**/ ?>