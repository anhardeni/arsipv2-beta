...
<div class="col-lg-12">
    <div class="card">
        <div class="card-header" style="margin-bottom: -30px">
            <h4 class="card-title">Impor Data PIB Hijau</h4>
        </div>
        <div class="card-body">
            ...
            <form onsubmit="return confirm('Are you sure move all data ?')" class="d-inline" action="<?php echo e(route('imporpib.move')); ?>" method="POST">
                <?php echo csrf_field(); ?>
            ...
            <div class="modal fade" id="imporpib" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <form method="post" action="<?php echo e(route("imporpib.impor_excel_hijau")); ?>" enctype="multipart/form-data">
...
<?php echo $__env->make("layouts.global", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\arsipv2-beta\resources\views/imporpib/hijau.blade.php ENDPATH**/ ?>