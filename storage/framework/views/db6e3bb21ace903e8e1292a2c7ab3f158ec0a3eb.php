<?php $__env->startSection("title"); ?> Batching Edit <?php $__env->stopSection(); ?>
...
<div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo e(route('batching.index')); ?>">Index</a></li>
                ...
                <div class="basic-form">
                    <form>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control border border-light bg-light" value="<?php echo e($batching->no_batch); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control border border-light" value="<?php echo e($batching->tanggal_batch); ?>" readonly>
                            </div>
                        </div>
        ...
        <div class="card">
            ...
            <div class="card-body" style="margin-top: -25px">
                <div class="basic-form">
                    ...
                    <form action="<?php echo e(route('batching.add_dok', ['id'=>$batching->id])); ?>" method="POST">
...
<script>
    var table = $('#pendok-table').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('batching.detail', ['id'=>$batching->id])); ?>",
        columns: [{
                data: 'DT_RowIndex',
                name: 'DT_RowIndex'
            },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.global", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\arsipv2-beta\resources\views/batching/edit.blade.php ENDPATH**/ ?>